...
//* Зробити щоб можна було окремо оновлювати імя і аватарку користувача
//* При загрузці аватарки кнопкою, при закритті модалки загрузки, випадає помилка і не оновлюється фотка
//* Зробити щоб при логінізації статус користувача мінявся на "онлайн"
